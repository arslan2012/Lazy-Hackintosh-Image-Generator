...
func Drop_Kernel() {//progress:1%
    Command(Bundle.main.path(forResource: "lzvn", ofType: nil)!, ["-d", "\(lazyImageMountPath)/System/Library/PrelinkedKernels/prelinkedkernel", "kernel"], "#COPYKERNELF#", 0, "/tmp/com.pcbeta.lazy/")
    Command("/bin/cp", ["/tmp/com.pcbeta.lazy/kernel", "\(lazyImageMountPath)/System/Library/Kernels"], "#COPYKERNELF#", 1)
