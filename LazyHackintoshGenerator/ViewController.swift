...
class ViewController: NSViewController {
    ...
    func startGenerating(){
        ...
        privilegedShellCommand("/bin/cp",arg: ["-R","/Volumes/OS X Base System/","/Volumes/OS X El Capitan Lazy Installer"], progress: 32)
        shellCommand("/bin/cp",arg: ["/Volumes/OS X Install ESD/BaseSystem.chunklist","/Volumes/OS X El Capitan Lazy Installer"], label: "复制Install ESD文件", progress: 2)
        shellCommand("/bin/cp",arg: ["/Volumes/OS X Install ESD/BaseSystem.dmg","/Volumes/OS X El Capitan Lazy Installer"], label: "复制Install ESD文件", progress: 2)
        shellCommand("/bin/cp",arg: ["/Volumes/OS X Install ESD/AppleDiagnostics.chunklist","/Volumes/OS X El Capitan Lazy Installer"], label: "复制Install ESD文件", progress: 2)
        shellCommand("/bin/cp",arg: ["/Volumes/OS X Install ESD/AppleDiagnostics.dmg","/Volumes/OS X El Capitan Lazy Installer"], label: "复制Install ESD文件", progress: 2)
        ...
        privilegedShellCommand("/bin/cp",arg: ["-R","/Volumes/OS X Install ESD/Packages","/Volumes/OS X El Capitan Lazy Installer/System/Installation"], progress: 20)
